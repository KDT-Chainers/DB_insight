...
17. [성능 측정값](#17-성능-측정값)
18. [파일명 정책 / Stem 해시](#18-파일명-정책--stem-해시)
19. [캐시 · 인덱스 불변식](#19-캐시--인덱스-불변식)
20. [관리자 UI](#20-관리자-ui)
21. [Wave 히스토리](#21-wave-히스토리)
22. [향후 개선 후보 (Wave5)](#22-향후-개선-후보-wave5)
...
### 3.2 SigLIP2-SO400M (`google/siglip2-so400m-patch14-384`) — Re 축
...
> **Movie/Rec의 특이점**: Re/Im/Z 세 축 모두 **BGE-M3(1024d) 동일 모델** 사용.
> AV 도메인은 텍스트(STT) 외 시각 정보 접근이 어려우므로 텍스트 공간 내에서 세 축을 운용.

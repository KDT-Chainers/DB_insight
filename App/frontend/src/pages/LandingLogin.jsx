    ...
    <div className="bg-surface-dim text-on-surface font-body overflow-hidden min-h-screen">
      ...
      <main className="relative z-10 min-h-screen flex flex-col items-center justify-center p-6">
        ...
        <div className="absolute top-12 flex flex-col items-center">
          ...
          <p className="text-[10px] font-semibold uppercase tracking-[0.2em] text-primary mt-2">Local Intelligence Protocol</p>
        </div>
        ...
        <div className="glass-panel w-full max-w-md rounded-xl p-10 shadow-[0_0_50px_rgba(0,0,0,0.3)] flex flex-col items-center gap-8 border border-white/5">
          ...
          <div className="text-center">
            <h2 className="text-xl font-bold text-on-surface tracking-tight">Security Clearance Required</h2>
            <p className="text-sm text-on-surface-variant mt-1">Authorized access to Neural Explorer</p>
          </div>

          {/* Form */}
          <form onSubmit={handleLogin} className="w-full space-y-6">
            <div className="relative group">
              <label className="text-[10px] uppercase font-bold tracking-widest text-primary mb-2 block ml-1">Access Token</label>
              <div className="relative">
        ...
        <div className="mt-12 flex items-center gap-4">
          <div className="glass-panel px-4 py-2 rounded-full border border-white/5 flex items-center gap-2">
            ...
            <span className="text-[10px] font-bold uppercase tracking-widest text-on-surface-variant">
              Node Status: <span className="text-primary">Optimal</span>
            </span>
          </div>
          <div className="glass-panel px-4 py-2 rounded-full border border-white/5 flex items-center gap-2">
      ...
      <div className="fixed bottom-0 left-0 p-8">
        <div className="flex items-center gap-4">
          ...
          <div className="hidden md:block">
            <p className="text-[8px] font-bold text-outline uppercase tracking-widest">Active Sequence</p>

...
EMBEDDED_DB_BGM   = EMBEDDED_DB  / "Bgm"   # 5번째 도메인 (BGM)
...
EXTRACTED_DB_BGM   = EXTRACTED_DB / "Bgm"  # 5번째 도메인 (BGM)

# ── 디렉토리 자동 생성 ─────────────────────────────────────
for _d in [
    EMBEDDED_DB_VIDEO, EMBEDDED_DB_DOC, EMBEDDED_DB_IMAGE, EMBEDDED_DB_AUDIO, EMBEDDED_DB_BGM,
    EXTRACTED_DB_VIDEO, EXTRACTED_DB_DOC, EXTRACTED_DB_IMAGE, EXTRACTED_DB_AUDIO, EXTRACTED_DB_BGM,
    RAW_DB / "Img", RAW_DB / "Doc",
    EXTRACTED_DB_BGM / "audio",  # mp4 → wav 캐시
]:

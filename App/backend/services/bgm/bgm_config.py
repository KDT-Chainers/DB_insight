...
TEXT_INDEX_PATH    = INDEX_DIR / "text_index.faiss"   # bgm_enrich_text.py 산출물
TEXT_IDS_PATH      = INDEX_DIR / "text_ids.json"      # 인덱스 순서 filename 목록
TEXT_EMB_PATH      = INDEX_DIR / "text_emb.npy"       # CLAP 텍스트 임베딩

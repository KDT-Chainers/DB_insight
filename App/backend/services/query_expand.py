...
_KO_EN: dict[str, list[str]] = {
    ...
    "남성":         ["man", "male", "men"],
    "학생":           ["student", "pupil"],
    # [v17.6] 신체 부위 — "사람 손"/"human hand" xlang @10=0 수정
    "손":           ["hand", "hands"],
    "발":           ["foot", "feet"],
    "얼굴":         ["face", "facial"],
    "눈동자":       ["eye", "eyes"],
    ...
    "보도자료":     ["press release", "press", "announcement"],
    "속보":         ["breaking news"],
    "단독":           ["exclusive", "scoop"],
    ...
    "연금":         ["pension"],
    "예산":         ["budget", "fiscal"],
    "재정":         ["finance", "financial", "fiscal", "budget", "public finance"],
    "재정준칙":     ["fiscal rule", "fiscal soundness", "fiscal consolidation"],
    "건전화":       ["soundness", "fiscal soundness", "stabilization"],
    "세금":         ["tax", "taxes"],
    ...
    "동향":         ["trend", "trends", "overview"],
    "추세":         ["trend", "trends", "tendency"],
    "정책":         ["policy", "policies"],
    ...
    # 탄소/환경무역
    "CBAM":         ["carbon border adjustment", "carbon border", "탄소국경조정", "EU 탄소"],
    "탄소국경":     ["carbon border", "CBAM", "carbon border adjustment mechanism"],
    "탄소국경조정": ["CBAM", "carbon border adjustment", "carbon border mechanism"],
    "온실가스":     ["greenhouse gas", "GHG", "emissions"],
    "탄소중립":     ["carbon neutral", "net zero", "carbon neutrality", "carbon zero"],
    "넷제로":       ["net zero", "carbon neutral", "zero emission"],
    "탄소세":       ["carbon tax", "carbon pricing", "carbon fee"],
    "탄소배출":     ["carbon emission", "CO2 emission", "greenhouse gas"],
    "탄소거래":     ["carbon trading", "emissions trading", "ETS"],
    # EN→KO 탄소/환경무역 역방향
    "cbam":         ["CBAM", "탄소국경조정", "탄소국경"],
    "carbon neutral": ["탄소중립", "넷제로"],
    "net zero":     ["넷제로", "탄소중립", "탄소제로"],
    "greenhouse":   ["온실가스", "온실"],
    "emission":     ["배출", "탄소배출", "온실가스"],
    "emissions":    ["배출", "탄소배출량"],
